    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Crown Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Crown Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  crown-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Crown Core is shutting down...") + "<br /><br />" +
